...
/* Definition of TPMI_MLKEM_PARAMS Constants */
...
#define TPM2_PT_PCR_DRTM_RESET                                                                     \
    ((TPM2_PT_PCR)0x00000012) /* a SET bit in the TPMS_PCR_SELECT indicates that the PCR is reset  \
                                 by a DRTM event. These PCR are reset to 1 on TPM2_Startup and     \
                                 reset to 0 on a _TPM_Hash_End event following a _TPM_Hash_Start   \
                                 event. */
#define TPM2_PT_PCR_POLICY                                                                         \
    ((TPM2_PT_PCR)0x00000013) /* a SET bit in the TPMS_PCR_SELECT indicates that the PCR is        \
                                 controlled by policy. This property is only present if the TPM    \
                                 supports policy control of a PCR. */
#define TPM2_PT_PCR_AUTH                                                                           \
    ((TPM2_PT_PCR)0x00000014) /* a SET bit in the TPMS_PCR_SELECT indicates that the PCR is        \
                                 controlled by an authorization value. This property is only       \
                                 present if the TPM supports authorization control of a PCR. */
#define TPM2_PT_TPM2_PCR_LAST                                                                      \
    ((TPM2_PT_PCR)0x00000014) /* top of the range of TPM2_PT_PCR properties of the implementation. \
                                 If the TPM receives a request for a PCR property with a value     \
                                 larger than this the TPM will return a zero length list and set   \
                                 the moreData parameter to NO. NOTE This is an                     \
                                 implementation-specific value. The value shown reflects the       \
 ...
 * 0x00000017 - 0x00000210 are reserved for the 2nd through 255th TPM2_PT_PCR_POLICY and
 * TPM2_PT_PCR_AUTH values. 0x00000211 is reserved to the 256th and highest allowed
 * TPM2_PT_PCR_POLICY set. 0x00000212 is reserved to the 256th and highest allowed TPM2_PT_PCR_AUTH
 * set. A new PCR property values may be assigned starting with value 0x00000213.
 */
...
#define TPM2_PS_PDA                                                                                \
    ((TPM2_PS)0x00000002) /* PDA includes all mobile devices that are not specifically cell phones \
                           */
...
#define TPM2_HT_PCR                                                                                \
    ((TPM2_HT)0x00) /* PCR  consecutive numbers starting at 0 that reference the PCR registers. A  \
                       platform-specific specification will set the minimum number of PCR and an   \
                       implementation may have more. */
#define TPM2_HT_NV_INDEX ((TPM2_HT)0x01) /* NV Index  assigned by the caller */
#define TPM2_HT_HMAC_SESSION                                                                       \
    ((TPM2_HT)0x02) /* HMAC Authorization Session  assigned by the TPM when the session is created \
                     */
#define TPM2_HT_LOADED_SESSION                                                                     \
    ((TPM2_HT)0x02) /* Loaded Authorization Session  used only in the context of                   \
                       TPM2_GetCapability. This type references both loaded HMAC and loaded policy \
                       authorization sessions. */
#define TPM2_HT_POLICY_SESSION                                                                     \
    ((TPM2_HT)0x03) /* Policy Authorization Session  assigned by the TPM when the session is       \
                       created */
#define TPM2_HT_SAVED_SESSION                                                                      \
    ((TPM2_HT)0x03) /* Saved Authorization Session  used only in the context of                    \
...
#define TPM2_HT_PERMANENT                                                                          \
    ((TPM2_HT)0x40) /* Permanent Values  assigned by this specification in                         \
                     */
#define TPM2_HT_TRANSIENT                                                                          \
    ((TPM2_HT)0x80) /* Transient Objects  assigned by the TPM when an object is loaded into        \
...
#define TPM2_HMAC_SESSION_LAST                                                                     \
    ((TPM2_HC)(TPM2_HMAC_SESSION_FIRST + 0x00fffffe))                /* last HMAC session */
...
#define TPM2_POLICY_SESSION_FIRST                                                                  \
    ((TPM2_HC)(TPM2_HR_POLICY_SESSION + 0)) /* first policy session                                \
                                             */
#define TPM2_POLICY_SESSION_LAST                                                                   \
    ((TPM2_HC)(TPM2_POLICY_SESSION_FIRST + 0x00fffffe))                /* last policy session */
...
#define TPM2_TRANSIENT_LAST                                                                        \
    ((TPM2_HC)(TPM2_TRANSIENT_FIRST + 0x00fffffe))                /* last transient object */
#define TPM2_PERSISTENT_FIRST ((TPM2_HC)(TPM2_HR_PERSISTENT + 0)) /* first persistent object */
#define TPM2_PERSISTENT_LAST                                                                       \
    ((TPM2_HC)(TPM2_PERSISTENT_FIRST + 0x00FFFFFF)) /* last persistent object */
#define TPM2_PLATFORM_PERSISTENT                                                                   \
    ((TPM2_HC)(TPM2_PERSISTENT_FIRST + 0x00800000))           /* first platform persistent object */
#define TPM2_NV_INDEX_FIRST ((TPM2_HC)(TPM2_HR_NV_INDEX + 0)) /* first allowed NV Index */
#define TPM2_NV_INDEX_LAST                                                                         \
    ((TPM2_HC)(TPM2_NV_INDEX_FIRST + 0x00FFFFFF)) /* last allowed NV Index                         \
                                                   */
...
#define TPMA_ALGORITHM_ASYMMETRIC                                                                  \
    ((TPMA_ALGORITHM)0x00000001) /* SET 1 an asymmetric algorithm with public and private          \
                                    portions. CLEAR 0 not an asymmetric algorithm */
#define TPMA_ALGORITHM_SYMMETRIC                                                                   \
    ((TPMA_ALGORITHM)0x00000002) /* SET 1 a symmetric block cipher. CLEAR 0 not a symmetric block  \
                                    cipher */
#define TPMA_ALGORITHM_HASH                                                                        \
    ((TPMA_ALGORITHM)0x00000004) /* SET 1 a hash algorithm. CLEAR 0 not a hash algorithm */
#define TPMA_ALGORITHM_OBJECT                                                                      \
    ((TPMA_ALGORITHM)0x00000008) /* SET 1 an algorithm that may be used as an object type. CLEAR 0 \
                                    an algorithm that is not used as an object type */
#define TPMA_ALGORITHM_RESERVED1_MASK ((TPMA_ALGORITHM)0x000000F0)
#define TPMA_ALGORITHM_SIGNING                                                                     \
    ((TPMA_ALGORITHM)0x00000100) /* SET 1 a signing algorithm. The setting of asymmetric symmetric \
                                    and hash will indicate the type of signing algorithm. CLEAR 0  \
                                    not a signing algorithm */
#define TPMA_ALGORITHM_ENCRYPTING                                                                  \
    ((TPMA_ALGORITHM)0x00000200) /* SET 1 an encryptiondecryption algorithm. The setting of        \
                                    asymmetric symmetric and hash will indicate the type of        \
                                    encryptiondecryption algorithm. CLEAR 0 not an                 \
                                    encryption-decryption algorithm */
#define TPMA_ALGORITHM_METHOD                                                                      \
    ((TPMA_ALGORITHM)0x00000400) /* SET 1 a method such as a key derivative function KDF. CLEAR 0  \
                                    not a method */
...
#define TPMA_OBJECT_FIXEDTPM                                                                       \
    ((TPMA_OBJECT)0x00000002) /* SET 1 The hierarchy of the object as indicated by its Qualified   \
                                 Name may not change. CLEAR 0 The hierarchy of the object may      \
                                 change as a result of this object or an ancestor key being        \
                                 duplicated for use in another hierarchy. */
#define TPMA_OBJECT_STCLEAR                                                                        \
    ((TPMA_OBJECT)0x00000004) /* SET 1 Previously saved contexts of this object may not be loaded  \
                                 after StartupCLEAR. CLEAR 0 Saved contexts of this object may be  \
                                 used after a ShutdownSTATE and subsequent Startup. */
#define TPMA_OBJECT_RESERVED2_MASK ((TPMA_OBJECT)0x00000008) /* shall be zero */
#define TPMA_OBJECT_FIXEDPARENT                                                                    \
    ((TPMA_OBJECT)0x00000010) /* SET 1 The parent of the object may not change. CLEAR 0 The parent \
                                 of the object may change as the result of a TPM2_Duplicate of the \
                                 object. */
#define TPMA_OBJECT_SENSITIVEDATAORIGIN                                                            \
    ((TPMA_OBJECT)0x00000020) /* SET 1 Indicates that when the object was created with TPM2_Create \
                                 or TPM2_CreatePrimary the TPM generated all of the sensitive data \
                                 other than the authValue. CLEAR 0 A portion of the sensitive data \
                                 other than the authValue was provided by the caller. */
#define TPMA_OBJECT_USERWITHAUTH                                                                   \
    ((TPMA_OBJECT)0x00000040) /* SET 1 Approval of USER role actions with this object may be with  \
                                 an HMAC session or with a password using the authValue of the     \
                                 object or a policy session. CLEAR 0 Approval of USER role actions \
                                 with this object may only be done with a policy session. */
#define TPMA_OBJECT_ADMINWITHPOLICY                                                                \
    ((TPMA_OBJECT)0x00000080) /* SET 1 Approval of ADMIN role actions with this object may only be \
                                 done with a policy session. CLEAR 0 Approval of ADMIN role        \
                                 actions with this object may be with an HMAC session or with a    \
                                 password using the authValue of the object or a policy session.   \
                               */
#define TPMA_OBJECT_FIRMWARELIMITED                                                                \
    ((TPMA_OBJECT)0x00000100) /* SET 1 Object is in a firmware-limited hierarchy */
#define TPMA_OBJECT_SVNLIMITED                                                                     \
    ((TPMA_OBJECT)0x00000200) /* SET 1 Object is in an SVN-limited hierarchy */
#define TPMA_OBJECT_RESERVED3_MASK ((TPMA_OBJECT)0x00000300) /* shall be zero */
#define TPMA_OBJECT_NODA                                                                           \
    ((TPMA_OBJECT)0x00000400) /* SET 1 The object is not subject to dictionary attack protections. \
                                 CLEAR 0 The object is subject to dictionary attack protections.   \
                               */
#define TPMA_OBJECT_ENCRYPTEDDUPLICATION                                                           \
    ((TPMA_OBJECT)0x00000800) /* SET 1 If the object is duplicated then symmetricAlg shall not be  \
                                 TPM2_ALG_NULL and newParentHandle shall not be TPM2_RH_NULL.      \
                                 CLEAR 0 The object may be duplicated without an inner wrapper on  \
                                 the private portion of the object and the new parent may be       \
                                 TPM2_RH_NULL. */
#define TPMA_OBJECT_RESERVED4_MASK ((TPMA_OBJECT)0x0000F000) /* shall be zero */
#define TPMA_OBJECT_RESTRICTED                                                                     \
    ((TPMA_OBJECT)0x00010000) /* SET 1 Key usage is restricted to manipulate structures of known   \
                                 format the parent of this key shall have restricted SET. CLEAR 0  \
                                 Key usage is not restricted to use on special formats. */
#define TPMA_OBJECT_DECRYPT                                                                        \
    ((TPMA_OBJECT)0x00020000) /* SET 1 The private portion of the key may be used to decrypt.      \
                                 CLEAR 0 The private portion of the key may not be used to         \
                                 decrypt. */
#define TPMA_OBJECT_SIGN_ENCRYPT                                                                   \
    ((TPMA_OBJECT)0x00040000) /* SET 1 For a symmetric cipher object the private portion of the    \
                                 key may be used to encrypt. For other objects the private portion \
                                 of the key may be used to sign. CLEAR 0 The private portion of    \
                                 the key may not be used to sign or encrypt. */
#define TPMA_OBJECT_X509SIGN                                                                       \
    ((TPMA_OBJECT)0x00080000) /* SET 1 For asymmetric key the private portion of the key may not   \
                                 be used as the signing key in TPM2_Sign. CLEAR 0 key can be used  \
                                 as the signing key in TPM2_Sign */
...
#define TPMA_SESSION_CONTINUESESSION                                                               \
    ((TPMA_SESSION)0x00000001) /* SET 1 In a command this setting indicates that the session is to \
                                  remain active after successful completion of the command. In a   \
                                  response it indicates that the session is still active. If SET   \
                                  in the command this attribute shall be SET in the response.      \
                                  ...
                                  session is closed and the context is no longer active. This      \
                                  attribute has no meaning for a password authorization and the    \
                                  TPM will allow any setting of the attribute in the command and   \
                                  SET the attribute in the response. This attribute will only be   \
                                  CLEAR in one response for a logical session. If the attribute is \
                                  CLEAR the context associated with the session is no longer in    \
                                  use and the space is available. A session created after another  \
                                  session is ended may have the same handle but logically is not   \
                                  the same session. This attribute has no effect if the command    \
                                  does not complete successfully. */
#define TPMA_SESSION_AUDITEXCLUSIVE                                                                \
    ((TPMA_SESSION)0x00000002) /* SET 1 In a command this setting indicates that the command       \
                                  should only be executed if the session is exclusive at the start \
                                  of the command. In a response it indicates that the session is   \
                                  exclusive. This setting is only allowed if the audit attribute   \
                                  is SET TPM2_RC_ATTRIBUTES. CLEAR 0 In a command indicates that   \
                                  the session need not be exclusive at the start of the command.   \
                                  In a response indicates that the session is not exclusive. In    \
                                  this revision if audit is CLEAR auditExclusive must be CLEAR in  \
                                  the command and will be CLEAR in the response.  In a future      \
                                  revision this bit may have a different meaning if audit is       \
                                  CLEAR. See Exclusive Audit Session clause in TPM 2.0 Part 1. */
#define TPMA_SESSION_AUDITRESET                                                                    \
    ((TPMA_SESSION)0x00000004) /* SET 1 In a command this setting indicates that the audit digest  \
                                  of the session should be initialized and the exclusive status of \
                                  the session SET. This setting is only allowed if the audit       \
                                  attribute is SET TPM2_RC_ATTRIBUTES. CLEAR 0 In a command        \
                                  indicates that the audit digest should not be initialized. This  \
                                  bit is always CLEAR in a response. In this revision if audit is  \
                                  CLEAR auditReset must be clear in the command and will be CLEAR  \
                                  in the response.  In a future revision this bit may have a       \
                                  different meaning if audit is CLEAR. */
#define TPMA_SESSION_RESERVED1_MASK ((TPMA_SESSION)0x00000018) /* shall be CLEAR */
#define TPMA_SESSION_DECRYPT                                                                       \
    ((TPMA_SESSION)0x00000020) /* SET 1 In a command this setting indicates that the first         \
                                  parameter in the command is symmetrically encrypted using the    \
                                  parameter encryption scheme described in TPM 2.0 Part 1. The TPM \
                                  will decrypt the parameter after performing any HMAC             \
                                  computations and before unmarshaling the parameter. In a         \
                                  response the attribute is copied from the request but has no     \
                                  effect on the response. CLEAR 0 Session not used for encryption. \
                                  For a password authorization this attribute will be CLEAR in     \
                                  both the command and response. This attribute may only be SET in \
                                  one session per command. This attribute may be SET in a session  \
                                  that is not associated with a command handle. Such a session is  \
                                  provided for purposes of encrypting a parameter and not for      \
                                  authorization. This attribute may be SET in combination with any \
                                  other session attributes. This attribute may only be SET if the  \
                                  first parameter of the command is a sized buffer TPM2B_. */
#define TPMA_SESSION_ENCRYPT                                                                       \
    ((TPMA_SESSION)0x00000040) /* SET 1 In a command this setting indicates that the TPM should    \
                                  use this session to encrypt the first parameter in the response. \
                                  In a response it indicates that the attribute was set in the     \
                                  command and that the TPM used the session to encrypt the first   \
                                  parameter in the response using the parameter encryption scheme  \
                                  described in TPM 2.0 Part 1. CLEAR 0 Session not used for        \
                                  encryption. For a password authorization this attribute will be  \
                                  CLEAR in both the command and response. This attribute may only  \
                                  be SET in one session per command. This attribute may be SET in  \
                                  a session that is not associated with a command handle. Such a   \
                                  session is provided for purposes of encrypting a parameter and   \
                                  not for authorization. This attribute may only be SET if the     \
                                  first parameter of a response is a sized buffer TPM2B_. */
#define TPMA_SESSION_AUDIT                                                                         \
    ((TPMA_SESSION)0x00000080) /* SET 1 In a command or response this setting indicates that the   \
                                  session is for audit and that auditExclusive and auditReset have \
                                  meaning. This session may also be used for authorization         \
                                  encryption or decryption. The encrypted and encrypt fields may   \
                                  be SET or CLEAR. CLEAR 0 Session is not used for audit. This     \
                                  attribute may only be SET in one session per command or          \
                                  response. If SET in the command then this attribute will be SET  \
                                  in the response. */
...
#define TPMA_LOCALITY_EXTENDED_MASK                                                                \
    ((TPMA_LOCALITY)0x000000E0) /* If any of these bits is set an extended locality is indicated   \
                                 */
...
#define TPMA_PERMANENT_OWNERAUTHSET                                                                \
    ((TPMA_PERMANENT)0x00000001) /* SET 1 TPM2_HierarchyChangeAuth with ownerAuth has been         \
                                    executed since the last TPM2_Clear. CLEAR 0 ownerAuth has not  \
                                    been changed since TPM2_Clear. */
#define TPMA_PERMANENT_ENDORSEMENTAUTHSET                                                          \
    ((TPMA_PERMANENT)0x00000002) /* SET 1 TPM2_HierarchyChangeAuth with endorsementAuth has been   \
                                    executed since the last TPM2_Clear. CLEAR 0 endorsementAuth    \
                                    has not been changed since TPM2_Clear. */
#define TPMA_PERMANENT_LOCKOUTAUTHSET                                                              \
    ((TPMA_PERMANENT)0x00000004) /* SET 1 TPM2_HierarchyChangeAuth with lockoutAuth has been       \
                                    executed since the last TPM2_Clear. CLEAR 0 lockoutAuth has    \
                                    not been changed since TPM2_Clear. */
#define TPMA_PERMANENT_RESERVED1_MASK ((TPMA_PERMANENT)0x000000F8)
#define TPMA_PERMANENT_DISABLECLEAR                                                                \
    ((TPMA_PERMANENT)0x00000100) /* SET 1 TPM2_Clear is disabled. CLEAR 0 TPM2_Clear is enabled.   \
                                    NOTE See TPM2_ClearControl in TPM 2.0 Part 3 for details on    \
                                    changing this attribute. */
#define TPMA_PERMANENT_INLOCKOUT                                                                   \
    ((TPMA_PERMANENT)0x00000200) /* SET 1 The TPM is in lockout and commands that require          \
                                    authorization with other than Platform Authorization or        \
                                    Lockout Authorization will not succeed. */
#define TPMA_PERMANENT_TPMGENERATEDEPS                                                             \
    ((TPMA_PERMANENT)0x00000400) /* SET 1 The EPS was created by the TPM. CLEAR 0 The EPS was      \
                                    created outside of the TPM using a manufacturer specific       \
                                    process. */
...
#define TPMA_STARTUP_CLEAR_PHENABLE                                                                \
    ((TPMA_STARTUP_CLEAR)0x00000001) /* SET 1 The platform hierarchy is enabled and platformAuth   \
                                        or platformPolicy may be used for authorization. CLEAR 0   \
                                        platformAuth and platformPolicy may not be used for        \
                                        authorizations and objects in the platform hierarchy       \
                                        including persistent objects cannot be used. NOTE See      \
                                        TPM2_HierarchyControl in TPM 2.0 Part 3 for details on     \
                                        changing this attribute. */
#define TPMA_STARTUP_CLEAR_SHENABLE                                                                \
    ((TPMA_STARTUP_CLEAR)0x00000002) /* SET 1 The Storage hierarchy is enabled and ownerAuth or    \
                                        ownerPolicy may be used for authorization. NV indices      \
                                        defined using owner authorization are accessible. CLEAR 0  \
                                        ownerAuth and ownerPolicy may not be used for              \
                                        authorizations and objects in the Storage hierarchy        \
                                        persistent objects and NV indices defined using owner      \
                                        authorization cannot be used. NOTE See                     \
                                        TPM2_HierarchyControl in TPM 2.0 Part 3 for details on     \
                                        changing this attribute. */
#define TPMA_STARTUP_CLEAR_EHENABLE                                                                \
    ((TPMA_STARTUP_CLEAR)0x00000004) /* SET 1 The EPS hierarchy is enabled and Endorsement         \
                                        Authorization may be used to authorize commands. CLEAR 0   \
                                        Endorsement Authorization may not be used for              \
                                        authorizations and objects in the endorsement hierarchy    \
                                        including persistent objects cannot be used. NOTE See      \
                                        TPM2_HierarchyControl in TPM 2.0 Part 3 for details on     \
                                        changing this attribute. */
#define TPMA_STARTUP_CLEAR_PHENABLENV                                                              \
    ((TPMA_STARTUP_CLEAR)0x00000008) /* SET 1 NV indices that have TPMA_PLATFORM_CREATE SET may be \
                                        read or written. The platform can create define and        \
                                        undefine indices. CLEAR 0 NV indices that have             \
                                        TPMA_PLATFORM_CREATE SET may not be read or written        \
                                        TPM2_RC_HANDLE. The platform cannot  define                \
                                        TPM2_RC_HIERARCHY or undefined TPM2_RC_HANDLE indices.     \
                                        NOTE See TPM2_HierarchyControl in TPM 2.0 Part 3 for       \
                                        details on changing this attribute. NOTE read refers to    \
                                        these commands TPM2_NV_Read TPM2_NV_ReadPublic             \
                                        TPM_NV_Certify TPM2_PolicyNVwrite refers to these commands \
                                        TPM2_NV_Write TPM2_NV_Increment TPM2_NV_Extend             \
                                        TPM2_NV_SetBitsNOTE The TPM must query the index           \
                                        TPMA_PLATFORM_CREATE attribute to determine whether        \
                                        phEnableNV is applicable. Since the TPM will return        \
                                        TPM2_RC_HANDLE if the index does not exist it also returns \
                                        this error code if the index is disabled. Otherwise the    \
                                        TPM would leak the existence of an index even when         \
                                        disabled. */
#define TPMA_STARTUP_CLEAR_RESERVED1_MASK ((TPMA_STARTUP_CLEAR)0x7FFFFFF0) /* shall be zero */
#define TPMA_STARTUP_CLEAR_ORDERLY                                                                 \
    ((TPMA_STARTUP_CLEAR)0x80000000) /* SET 1 The TPM received a TPM2_Shutdown and a matching      \
                                        TPM2_Startup. CLEAR 0 TPM2_StartupTPM2_SU_CLEAR was not    \
                                        preceded by a TPM2_Shutdown of any type. NOTE A shutdown   \
                                        is orderly if the TPM receives a TPM2_Shutdown of any type \
                                        followed by a TPM2_Startup of any type. However the TPM    \
                                        will return an error if TPM2_StartupTPM2_SU_STATE was not  \
                                        preceded by TPM2_State_SaveTPM2_SU_STATE. */

/* Definition of UINT32 TPMA_MEMORY Bits <Out> */
typedef uint32_t TPMA_MEMORY;

#define TPMA_MEMORY_SHAREDRAM                                                                      \
    ((TPMA_MEMORY)0x00000001) /* SET 1 indicates that the RAM memory used for authorization        \
                                 session contexts is shared with the memory used for transient     \
                                 objects. CLEAR 0 indicates that the memory used for authorization \
                                 sessions is not shared with memory used for transient objects */
#define TPMA_MEMORY_SHAREDNV                                                                       \
    ((TPMA_MEMORY)0x00000002) /* SET 1 indicates that the NV memory used for persistent objects is \
                                 shared with the NV memory used for NV Index values. CLEAR 0       \
                                 indicates that the persistent objects and NV Index values are     \
                                 allocated from separate sections of NV */
#define TPMA_MEMORY_OBJECTCOPIEDTORAM                                                              \
    ((TPMA_MEMORY)0x00000004) /* SET 1 indicates that the TPM copies persistent objects to a       \
                                 transientobject slot in RAM when the persistent object is         \
                                 referenced in a command. The TRM is required to make sure that an \
                                 object slot is available. CLEAR 0 indicates that the TPM does not \
                                 use transientobject slots when persistent objects are referenced  \
                               */
...
#define TPMA_CC_NV                                                                                 \
    ((TPMA_CC)0x00400000) /* SET 1 indicates that the command may write to NV. CLEAR 0 indicates   \
                             that the command does not write to NV */
#define TPMA_CC_EXTENSIVE                                                                          \
    ((TPMA_CC)0x00800000) /* SET 1 This command could flush any number of loaded contexts. CLEAR 0 \
                             no additional changes other than indicated by the flushed attribute   \
                           */
#define TPMA_CC_FLUSHED                                                                            \
    ((TPMA_CC)0x01000000) /* SET 1 The context associated with any transient handle in the command \
                             will be flushed when this command completes. CLEAR 0 No context is    \
                             flushed as a side effect of this command. */
#define TPMA_CC_CHANDLES_MASK                                                                      \
    ((TPMA_CC)0x0E000000) /* indicates the number of the handles in the handle area for this       \
                             command */
#define TPMA_CC_CHANDLES_SHIFT (25)
#define TPMA_CC_RHANDLE                                                                            \
    ((TPMA_CC)0x10000000) /* SET 1 indicates the presence of the handle area in the response */
#define TPMA_CC_V                                                                                  \
    ((TPMA_CC)0x20000000) /* SET 1 indicates that the command is vendor-specific. CLEAR 0          \
                             indicates that the command is defined in a version of this            \
                             specification */
...
#define TPMA_MODES_FIPS_140_2                                                                      \
    ((TPMA_MODES)0x00000001) /* SET 1 indicates that the TPM is designed to comply with all of the \
                                FIPS 1402 requirements at Level 1 or higher. */
...
#define TPMA_X509_KEY_USAGE_DECIPHER_ONLY                                                          \
    ((TPMA_X509_KEY_USAGE)0x00800000) /* As described in RFC5280. Requires objct                   \
                                         attributes.Decrypt to be SET */
#define TPMA_X509_KEY_USAGE_ENCIPHER_ONLY                                                          \
    ((TPMA_X509_KEY_USAGE)0x01000000) /* As described in RFC5280. Requires objct                   \
                                         attributes.Decrypt to be SET */
#define TPMA_X509_KEY_USAGE_CRLSIGN                                                                \
    ((TPMA_X509_KEY_USAGE)0x02000000) /* As described in RFC5280. Requires objct attributes.Sign   \
                                         to be SET */
#define TPMA_X509_KEY_USAGE_KEYCERTSIGN                                                            \
    ((TPMA_X509_KEY_USAGE)0x04000000) /* As described in RFC5280. Requires objct attributes.Sign   \
                                         to be SET */
#define TPMA_X509_KEY_USAGE_KEYAGREEMENT                                                           \
    ((TPMA_X509_KEY_USAGE)0x08000000) /* As described in RFC5280. Requires objct                   \
                                         attributes.Decrypt to be SET */
#define TPMA_X509_KEY_USAGE_DATAENCIPHERMENT                                                       \
    ((TPMA_X509_KEY_USAGE)0x10000000) /* As described in RFC5280. Requires objct                   \
                                         attributes.Decrypt to be SET */
#define TPMA_X509_KEY_USAGE_KEYENCIPHERMENT                                                        \
    ((TPMA_X509_KEY_USAGE)0x20000000) /* As described in RFC5280. Requires objct                   \
                                         attributes.Decrypt and Restricted to be SET */
#define TPMA_X509_KEY_USAGE_NONREPUDIATION                                                         \
    ((TPMA_X509_KEY_USAGE)0x40000000) /* As described in RFC5280. Requires objct                   \
                                         attributes.fixedTPM to be SET in the SubjectKey */
#define TPMA_X509_KEY_USAGE_DIGITALSIGNATURE                                                       \
    ((TPMA_X509_KEY_USAGE)0x80000000) /* As described in RFC5280. Requires objct attributes.Sign   \
                                         to be SET in the SubjectKey */

/* Definition of UINT32 TPMA_ACT Bits */
typedef uint32_t TPMA_ACT;

#define TPMA_ACT_SIGNALED                                                                          \
    ((TPMA_ACT)0x00000001) /* SET 1 The ACT has signaled. CLEAR 0 The ACT has not signaled */
#define TPMA_ACT_PRESERVESIGNALED                                                                  \
    ((TPMA_ACT)0x00000002) /* SET 1 The ACT signaled bit is preserved over a power cycle. CLEAR 0  \
                              The ACT signaled bit is not preserved over a power cycle */
...
#define TPMI_DH_SAVED_TRANSIENT_CLEAR                                                              \
    ((TPMI_DH_SAVED)0x80000002) /* a transient object with the stClear attribute SET */
...
struct TPMT_HA {
    TPMI_ALG_HASH
    hashAlg;        /* selector of the hash contained in the digest that implies the size of the
                       digest. NOTE The leading + on the type indicates that this structure should pass
                       an indication to the unmarshaling function for TPMI_ALG_HASH so that
                       TPM2_ALG_NULL will be allowed if a use of a TPMT_HA allows TPM2_ALG_NULL. */
...
struct TPML_CC {
    ...
    TPM2_CC commandCodes[TPM2_MAX_CAP_CC]; /* a list of command codes. The maximum only applies to a
                                              command code list in a command. The response size is
...
struct TPML_ALG {
    ...
    TPM2_ALG_ID
    algorithms[TPM2_MAX_ALG_LIST_SIZE]; /* a list of algorithm IDs. The maximum only applies to
                                           an algorithm list in a command. The response size is
                                           limited only by the size of the parameter buffer. */
};
...
struct TPML_DIGEST {
    ...
    TPM2B_DIGEST
    digests[8]; /* a list of digestsFor TPM2_PolicyOR all digests will have been computed using
                   the digest of the policy session. For TPM2_PCR_Read each digest will be the
                   size of the digest for the bank containing the PCR. */
};
...
struct TPMS_CLOCK_INFO {
    UINT64 clock;      /* time in milliseconds during which the TPM has been powered. This structure
                          element is used to report on the TPMs Clock value. The value of Clock shall be
                          recorded in nonvolatile memory no less often than once per 69.9 minutes, 222
                          milliseconds of TPM operation. The reference for the millisecond timer is the
                          TPM oscillator. This value is reset to zero when the Storage Primary Seed is
                          changed TPM2_Clear. This value may be advanced by TPM2_AdvanceClock. */
    UINT32 resetCount; /* number of occurrences of TPM Reset since the last TPM2_Clear */
    UINT32 restartCount; /* number of times that TPM2_Shutdown or _TPM_Hash_Start have occurred
                            since the last TPM Reset or TPM2_Clear. */
    TPMI_YES_NO safe;    /* no value of Clock greater than the current value of Clock has been
...
struct TPMS_TIME_INFO {
    UINT64 time; /* time in milliseconds since the last _TPM_Init or TPM2_Startup. This structure
                    element is used to report on the TPMs Time value. */
...
struct TPMS_TIME_ATTEST_INFO {
    ...
    UINT64 firmwareVersion; /* a TPM vendor-specific value indicating the version number of the
                               firmware */
};
...
struct TPMS_SESSION_AUDIT_INFO {
    TPMI_YES_NO
    exclusiveSession; /* current exclusive status of the session. TRUE if all of the commands
                         recorded in the sessionDigest were executed without any intervening TPM
                         command that did not use this audit session */
...
struct TPMS_ATTEST {
    TPM2_GENERATED magic; /* the indication that this structure was created by a TPM always
    ...
    TPM2B_DATA extraData; /* external information supplied by caller. NOTE A TPM2B_DATA structure
                             provides room for a digest and a method indicator to indicate the
                             components of the digest. The definition of this method indicator is
                             outside the scope of this specification. */
    TPMS_CLOCK_INFO clockInfo; /* Clock resetCount restartCount and Safe */
    UINT64 firmwareVersion;    /* TPM vendor-specific value identifying the version number of the
                                  firmware */
...
typedef TPMS_SCHEME_HASH
    TPMS_SCHEME_KDF1_SP800_56A;            /* hash-based key or mask generation functions */
typedef TPMS_SCHEME_HASH TPMS_SCHEME_KDF2; /* hash-based key or mask generation functions */
typedef TPMS_SCHEME_HASH
    TPMS_SCHEME_KDF1_SP800_108; /* hash-based key or mask generation functions */
...
struct TPMS_ALGORITHM_DETAIL_ECC {
    ...
    TPMT_KDF_SCHEME kdf;  /* if not TPM2_ALG_NULL the required KDF and hash algorithm used in secret
                             sharing operations */
    TPMT_ECC_SCHEME sign; /* If not TPM2_ALG_NULL this is the mandatory signature scheme that is
...
struct TPMS_SIGNATURE_RSA {
    TPMI_ALG_HASH
    hash; /* the hash algorithm used to digest the message. TPM2_ALG_NULL is not allowed. */
...
struct TPMS_SIGNATURE_ECC {
    TPMI_ALG_HASH
    hash; /* the hash algorithm used in the signature processTPM2_ALG_NULL is not allowed. */
...
struct TPMS_KEYEDHASH_PARMS {
    ...
    scheme; /* Indicates the signing method used for a keyedHash signing object. This field also
               determines the size of the data field for a data object created with TPM2_Create
...
struct TPMS_ASYM_PARMS {
    TPMT_SYM_DEF_OBJECT
    symmetric; /* the companion symmetric algorithm for a restricted decryption key and shall be
                  set to a supported symmetric algorithm. This field is optional for keys that
                  are not decryption keys and shall be set to TPM2_ALG_NULL if not used. */
    TPMT_ASYM_SCHEME
    scheme; /* For a key with the sign attribute SET a valid signing scheme for the key type.
               For a key with the decrypt attribute SET a valid key exchange protocol. For a key
               with sign and decrypt attributes shall be TPM2_ALG_NULL */
};
...
struct TPMS_RSA_PARMS {
    TPMT_SYM_DEF_OBJECT
    symmetric; /* for a restricted decryption key shall be set to a supported symmetric
...
struct TPMS_ECC_PARMS {
    ...
    symmetric; /* for a restricted decryption key shall be set to a supported symmetric
                  ...
                  this field shall be set to TPM2_ALG_NULL. */
    TPMT_ECC_SCHEME
    scheme; /* If the sign attribute of the key is SET then this shall be a valid signing
               scheme. NOTE If the sign parameter in curveID indicates a mandatory scheme then
               this field shall have the same value. If the decrypt attribute of the key is SET
               then this shall be a valid key exchange scheme or TPM2_ALG_NULL. If the key is a
               Storage Key then this field shall be TPM2_ALG_NULL. */
    TPMI_ECC_CURVE curveID; /* ECC curve ID */
    TPMT_KDF_SCHEME
    kdf; /* an optional key derivation scheme for generating a symmetric key from a Z value. If
            the kdf  parameter associated with curveID is not TPM2_ALG_NULL then this is
            required to be NULL. NOTE There are currently no commands where this parameter has
...
struct TPMT_PUBLIC {
    ...
    TPMI_ALG_HASH   nameAlg;      /* algorithm used for computing the Name of the object NOTE The +
                                     indicates that the instance of a TPMT_PUBLIC may have a + to indicate
                                     that the nameAlg may be TPM2_ALG_NULL. */
    TPMA_OBJECT objectAttributes; /* attributes that along with type determine the manipulations of
                                     this object */
    TPM2B_DIGEST authPolicy; /* optional policy for using this key. The policy is computed using the
                                nameAlg of the object. NOTE Shall be the Empty Policy if no
                                authorization policy is present. */
    TPMU_PUBLIC_PARMS parameters; /* the algorithm or structure details */
    TPMU_PUBLIC_ID    unique; /* the unique identifier of the structure. For an asymmetric key this
...
struct TPMT_SENSITIVE {
    TPMI_ALG_PUBLIC sensitiveType; /* identifier for the sensitive area. This shall be the same as
                                      the type parameter of the associated public area. */
    TPM2B_AUTH authValue;   /* user authorization data. The authValue may be a zero-length string.
                               This value shall not be larger than the size of the digest produced by
                               the nameAlg of the object. */
    TPM2B_DIGEST seedValue; /* for asymmetric key object the optional protection seed for other
                               objects the obfuscation value. This value shall not be larger than
                               the size of the digest produced by nameAlg of the object. */
...
struct TPMS_ID_OBJECT {
    ...
    TPM2B_DIGEST
    encIdentity; /* credential protector information returned if name matches the referenced
                    objectAll of the encIdentity is encrypted including the size field. NOTE The
                    TPM is not required to check that the size is not larger than the digest of
                    the nameAlg. However if the size is larger the ID object may not be usable
                    on a TPM that has no digest larger than produced by nameAlg. */
};
...
#define TPM2_NV_INDEX_RH_NV_MASK                                                                   \
    ((TPM2_NV_INDEX)0xFF000000) /* constant value of TPM2_HT_NV_INDEX indicating the NV Index      \
                                   range */
...
#define TPM2_NT_ORDINARY                                                                           \
    ((TPM2_NT)0x0) /* Ordinary contains data that is opaque to the TPM that can only be modified   \
                      using TPM2_NV_Write. */
#define TPM2_NT_COUNTER                                                                            \
    ((TPM2_NT)0x1) /* Counter contains an 8-octet value that is to be used as a counter and can    \
                      only be modified with TPM2_NV_Increment */
#define TPM2_NT_BITS                                                                               \
    ((TPM2_NT)0x2) /* Bit Field contains an 8-octet value to be used as a bit field and can only   \
                      be modified with TPM2_NV_SetBits. */
#define TPM2_NT_EXTEND                                                                             \
    ((TPM2_NT)0x4) /* Extend contains a digestsized value used like a PCR. The Index can only be   \
                      modified using TPM2_NV_Extend. The extend will use the nameAlg of the Index. \
                    */
#define TPM2_NT_PIN_FAIL                                                                           \
    ((TPM2_NT)0x8) /* PIN Fail contains a pinCount that increments on a PIN authorization failure  \
                      and a pinLimit */
#define TPM2_NT_PIN_PASS                                                                           \
    ((TPM2_NT)0x9) /* PIN Pass contains a pinCount that increments on a PIN authorization success  \
                      and a pinLimit */
...
struct TPMS_NV_PIN_COUNTER_PARAMETERS {
    UINT32 pinCount; /* This counter shows the current number of successful authValue authorization
                        attempts to access a TPM2_NT_PIN_PASS index or the current number of
                        unsuccessful authValue authorization attempts to access a TPM2_NT_PIN_FAIL
                        index. */
    UINT32 pinLimit; /* This threshold is the value of pinCount at which the authValue authorization
                        of the host TPM2_NT_PIN_PASS or TPM2_NT_PIN_FAIL index is locked out. */
};

/* Definition of UINT32 TPMA_NV Bits */
typedef uint32_t TPMA_NV;

#define TPMA_NV_PPWRITE                                                                            \
    ((TPMA_NV)0x00000001) /* SET 1 The Index data can be written if Platform Authorization is      \
                             provided. CLEAR 0 Writing of the Index data cannot be authorized with \
                             Platform Authorization. */
#define TPMA_NV_OWNERWRITE                                                                         \
    ((TPMA_NV)0x00000002) /* SET 1 The Index data can be written if Owner Authorization is         \
                             provided. CLEAR 0 Writing of the Index data cannot be authorized with \
                             Owner Authorization. */
#define TPMA_NV_AUTHWRITE                                                                          \
    ((TPMA_NV)0x00000004) /* SET 1 Authorizations to change the Index contents that require USER   \
                             role may be provided with an HMAC session or password. CLEAR 0        \
                             Authorizations to change the Index contents that require USER role    \
                             may not be provided with an HMAC session or password. */
#define TPMA_NV_POLICYWRITE                                                                        \
    ((TPMA_NV)0x00000008) /* SET 1 Authorizations to change the Index contents that require USER   \
                             role may be provided with a policy session. CLEAR 0 Authorizations to \
                             change the Index contents that require USER role may not be provided  \
                             with a policy session. NOTE TPM2_NV_ChangeAuth always requires that   \
                             authorization be provided in a policy session. */
#define TPMA_NV_TPM2_NT_MASK                                                                       \
    ((TPMA_NV)0x000000F0) /* The type of the index. NOTE A TPM is not required to support all      \
                             TPM2_NT values */
#define TPMA_NV_TPM2_NT_SHIFT  (4)
#define TPMA_NV_RESERVED1_MASK ((TPMA_NV)0x00000300) /* shall be zero. Reserved for future use */
#define TPMA_NV_POLICY_DELETE                                                                      \
    ((TPMA_NV)0x00000400) /* SET 1 Index may not be deleted unless the authPolicy is satisfied     \
                             using TPM2_NV_UndefineSpaceSpecial. CLEAR 0 Index may be deleted with \
                             proper platform or owner authorization using TPM2_NV_UndefineSpace.   \
                           */
#define TPMA_NV_WRITELOCKED                                                                        \
    ((TPMA_NV)0x00000800) /* SET 1 Index cannot be written. CLEAR 0 Index can be written. */
#define TPMA_NV_WRITEALL                                                                           \
    ((TPMA_NV)0x00001000) /* SET 1 A partial write of the Index data is not allowed. The write     \
                             size shall match the defined space size. CLEAR 0 Partial writes are   \
                             allowed. This setting is required if the .dataSize of the Index is    \
                             larger than NV_MAX_BUFFER_SIZE for the implementation. */
#define TPMA_NV_WRITEDEFINE                                                                        \
    ((TPMA_NV)0x00002000) /* SET 1 TPM2_NV_WriteLock may be used to prevent further writes to this \
                             location. CLEAR 0 TPM2_NV_WriteLock does not block subsequent writes  \
                             if TPMA_NV_WRITE_STCLEAR is also CLEAR. */
#define TPMA_NV_WRITE_STCLEAR                                                                      \
    ((TPMA_NV)0x00004000) /* SET 1 TPM2_NV_WriteLock may be used to prevent further writes to this \
                             location until the next TPM Reset or TPM Restart. CLEAR 0             \
                             TPM2_NV_WriteLock does not block subsequent writes if                 \
                             TPMA_NV_WRITEDEFINE is also CLEAR. */
#define TPMA_NV_GLOBALLOCK                                                                         \
    ((TPMA_NV)0x00008000) /* SET 1 If TPM2_NV_GlobalWriteLock is successful then further writes to \
                             this location are not permitted until the next TPM Reset or TPM       \
                             Restart. CLEAR 0 TPM2_NV_GlobalWriteLock has no effect on the writing \
                             of the data at this Index. */
#define TPMA_NV_PPREAD                                                                             \
    ((TPMA_NV)0x00010000) /* SET 1 The Index data can be read if Platform Authorization is         \
                             provided. CLEAR 0 Reading of the Index data cannot be authorized with \
                             Platform Authorization. */
#define TPMA_NV_OWNERREAD                                                                          \
    ((TPMA_NV)0x00020000) /* SET 1 The Index data can be read if Owner Authorization is provided.  \
                             CLEAR 0 Reading of the Index data cannot be authorized with Owner     \
                             Authorization. */
#define TPMA_NV_AUTHREAD                                                                           \
    ((TPMA_NV)0x00040000) /* SET 1 The Index data may be read if the authValue is provided. CLEAR  \
                             0 Reading of the Index data cannot be authorized with the Index       \
                             authValue. */
#define TPMA_NV_POLICYREAD                                                                         \
    ((TPMA_NV)0x00080000) /* SET 1 The Index data may be read if the authPolicy is satisfied.      \
...
#define TPMA_NV_NO_DA                                                                              \
    ((TPMA_NV)0x02000000) /* SET 1 Authorization failures of the Index do not affect the DA logic  \
                             and authorization of the Index is not blocked when the TPM is in      \
                             Lockout mode. CLEAR 0 Authorization failures of the Index will        \
                             increment the authorization failure counter and authorizations of     \
                             this Index are not allowed when the TPM is in Lockout mode. */
#define TPMA_NV_ORDERLY                                                                            \
    ((TPMA_NV)0x04000000) /* SET 1 NV Index state is only required to be saved when the TPM        \
                             performs an orderly shutdown TPM2_Shutdown. CLEAR 0 NV Index state is \
                             required to be persistent after the command to update the Index       \
                             completes successfully, that is, the NV update is synchronous with    \
                             the update command. */
#define TPMA_NV_CLEAR_STCLEAR                                                                      \
    ((TPMA_NV)0x08000000) /* SET 1 TPMA_NV_WRITTEN for the Index is CLEAR by TPM Reset or TPM      \
                             Restart. CLEAR 0 TPMA_NV_WRITTEN is not changed by TPM Restart. NOTE  \
                             1    This attribute may only be SET if TPM2_NT is not                 \
                             TPM2_NT_COUNTER. NOTE 2    If the TPMA_NV_ORDERLY is SET              \
                             TPMA_NV_WRITTEN will be CLEAR by TPM Reset. */
#define TPMA_NV_READLOCKED                                                                         \
    ((TPMA_NV)0x10000000) /* SET 1 Reads of the Index are blocked until the next TPM Reset or TPM  \
                             Restart. CLEAR 0 Reads of the Index are allowed if proper             \
                             authorization is provided. */
#define TPMA_NV_WRITTEN                                                                            \
    ((TPMA_NV)0x20000000) /* SET 1 Index has been written. CLEAR 0 Index has not been written. */
#define TPMA_NV_PLATFORMCREATE                                                                     \
    ((TPMA_NV)0x40000000) /* SET 1 This Index may be undefined with Platform Authorization but not \
                             with Owner Authorization. CLEAR 0 This Index may be undefined using   \
                             Owner Authorization but not with Platform Authorization. The TPM will \
                             validate that this attribute is SET when the Index is defined using   \
                             Platform Authorization and will validate that this attribute is CLEAR \
                             when the Index is defined using Owner Authorization. */
#define TPMA_NV_READ_STCLEAR                                                                       \
    ((TPMA_NV)0x80000000) /* SET 1 TPM2_NV_ReadLock may be used to SET TPMA_NV_READLOCKED for this \
                             Index. CLEAR 0 TPM2_NV_ReadLock has no effect on this Index. */
...
struct TPMS_NV_PUBLIC {
    ...
    TPMI_ALG_HASH
    nameAlg; /* hash algorithm used to compute the name of the Index and used for the
                authPolicy.  For an extend index the hash algorithm used for the extend. */
    TPMA_NV      attributes; /* the Index attributes */
    TPM2B_DIGEST authPolicy; /* optional access policy for the Index. The policy is computed using
                                the nameAlg . NOTE: this shall be the Empty Policy if no
                                authorization policy is present. */
    UINT16 dataSize; /* the size of the data area. The maximum size is implementation dependent. The
                        minimum maximum size is platform-specific. */
};
...
struct TPMS_CONTEXT {
    UINT64 sequence; /* the sequence number of the context. NOTE Transient object contexts and
                        session contexts used different counters. */
    TPMI_DH_CONTEXT savedHandle;    /* a handle indicating if the context is a session object or
                                       sequence objectSee Context Handle Values */
...
struct TPMS_CREATION_DATA {
    ...
    TPM2B_DIGEST pcrDigest; /* digest of the selected PCR using nameAlg of the object for which this
                               structure is being created. pcrDigest.size shall be zero if the
    ...
    TPM2B_NAME
    parentName; /* Name of the parent at time of creation. The size will match digest size
                   associated with parentNameAlg unless it is TPM2_ALG_NULL in which case the
                   size will be 4 and parentName will be the hierarchy handle. */
    TPM2B_NAME parentQualifiedName; /* Qualified Name of the parent at the time of creationSize is
                                       the same as parentName. */
...
#define TPM_AT_ANY                                                                                 \
    ((TPM_AT)0x00000000) /* In a command, a non-specific request for AC information. In a          \
...
#define TPM_AT_PV1                                                                                 \
    ((TPM_AT)0x00000002) /* Indicates the most significant 32 bits of a pairing value for the AC   \
                          */
#define TPM_AT_VEND                                                                                \
    ((TPM_AT)0x80000000) /* Value added to a TPM_AT to indicate a vendor-specific tag value */

typedef UINT32 TPM_EA;

#define TPM_AE_NONE                                                                                \
    ((UINT32)0x00000000) /* In a command, a non-specific request for AC information. In a          \
                            response, indicates that outputData is not meaningful */
