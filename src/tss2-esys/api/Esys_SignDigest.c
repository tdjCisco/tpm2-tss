...
/** One-Call function for TPM2_SignDigest
 *
 * This function invokes the TPM2_SignDigest command in a one-call
...
Esys_SignDigest(ESYS_CONTEXT               *esysContext,
     ...
     */
    do {
        r = Esys_SignDigest_Finish(esysContext, signature);
...
/** Asynchronous function for TPM2_SignDigest
 *
 * This function invokes the TPM2_SignDigest command in asynchronous variant.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  keyHandle Handle of the signing key.
 * @param[in]  shandle1 Session handle for authorization of keyHandle.
...
/** Asynchronous finish function for TPM2_SignDigest
 *
 * This function returns the results of a TPM2_SignDigest command
 * invoked via Esys_SignDigest_Async.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[out] signature The signature (callee-allocated).
