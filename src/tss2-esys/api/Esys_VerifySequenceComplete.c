...
/** One-Call function for TPM2_VerifySequenceComplete
 *
 * This function invokes the TPM2_VerifySequenceComplete command in a one-call
 * variant. This means the function will block until the TPM response is
 * available. All input parameters are const. The memory for non-simple output
 * parameters is allocated by the function implementation.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  sequenceHandle Handle for the verification sequence.
 ...
 * @param[out] validation Ticket indicating successful verification (callee-allocated).
...
/** Asynchronous function for TPM2_VerifySequenceComplete
 *
 * This function invokes the TPM2_VerifySequenceComplete command in asynchronous variant.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  sequenceHandle Handle for the verification sequence.
 * @param[in]  keyHandle Handle of the verification key.
...
Esys_VerifySequenceComplete_Async(ESYS_CONTEXT        *esysContext,
    ...
    LOG_TRACE("context=%p, sequenceHandle=%" PRIx32 ", keyHandle=%" PRIx32 ", signature=%p",
              esysContext, sequenceHandle, keyHandle, signature);
...
/** Asynchronous finish function for TPM2_VerifySequenceComplete
 *
 * This function returns the results of a TPM2_VerifySequenceComplete command
 * invoked via Esys_VerifySequenceComplete_Async.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[out] validation Ticket indicating successful verification (callee-allocated).
