...
/** One-Call function for TPM2_Decapsulate
 *
 * This function invokes the TPM2_Decapsulate command in a one-call
 * variant. This means the function will block until the TPM response is
 * available. All input parameters are const. The memory for non-simple output
 * parameters is allocated by the function implementation.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  keyHandle Handle of the ML-KEM key.
 * @param[in]  shandle1 Session handle for authorization of keyHandle.
 * @param[in]  shandle2 Second session handle.
 * @param[in]  shandle3 Third session handle.
 * @param[in]  ciphertext The ML-KEM ciphertext to decapsulate.
 * @param[out] secret The shared secret (callee-allocated).
...
Esys_Decapsulate(ESYS_CONTEXT               *esysContext,
     ...
     */
    do {
        r = Esys_Decapsulate_Finish(esysContext, secret);
...
/** Asynchronous function for TPM2_Decapsulate
 *
 * This function invokes the TPM2_Decapsulate command in asynchronous variant.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  keyHandle Handle of the ML-KEM key.
 * @param[in]  shandle1 Session handle for authorization of keyHandle.
...
Esys_Decapsulate_Async(ESYS_CONTEXT                *esysContext,
    ...
    r = Tss2_Sys_Decapsulate_Prepare(
...
/** Asynchronous finish function for TPM2_Decapsulate
 *
 * This function returns the results of a TPM2_Decapsulate command
 * invoked via Esys_Decapsulate_Async.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[out] secret The shared secret (callee-allocated).
...
Esys_Decapsulate_Finish(ESYS_CONTEXT *esysContext, TPM2B_SHARED_SECRET **secret) {
    TSS2_RC r;
    LOG_TRACE("context=%p, secret=%p", esysContext, secret);
