 ...
 * @param[in]  sequenceHandle Handle for the signature sequence.
 ...
 * @param[in]  buffer Optional data to be included in the signature.
 * @param[out] signature The signature (callee-allocated).
...
Esys_SignSequenceComplete(ESYS_CONTEXT            *esysContext,
     ...
     */
    do {
        r = Esys_SignSequenceComplete_Finish(esysContext, signature);
...
/** Asynchronous function for TPM2_SignSequenceComplete
 *
 * This function invokes the TPM2_SignSequenceComplete command in asynchronous variant.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  sequenceHandle Handle for the signature sequence.
 * @param[in]  keyHandle Handle of the signing key.
...
/** Asynchronous finish function for TPM2_SignSequenceComplete
 *
 * This function returns the results of a TPM2_SignSequenceComplete command
 * invoked via Esys_SignSequenceComplete_Async.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[out] signature The signature (callee-allocated).
