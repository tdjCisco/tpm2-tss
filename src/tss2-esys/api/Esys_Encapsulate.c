...
/** One-Call function for TPM2_Encapsulate
 *
 * This function invokes the TPM2_Encapsulate command in a one-call
 ...
 * @param[out] ciphertext The ML-KEM ciphertext (callee-allocated).
...
Esys_Encapsulate(ESYS_CONTEXT             *esysContext,
     ...
     */
    do {
        r = Esys_Encapsulate_Finish(esysContext, ciphertext, secret);
...
/** Asynchronous function for TPM2_Encapsulate
 *
 * This function invokes the TPM2_Encapsulate command in asynchronous variant.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  keyHandle Handle of the ML-KEM key.
 * @param[in]  shandle1 Session handle for authorization of keyHandle.
...
Esys_Encapsulate_Async(ESYS_CONTEXT *esysContext,
                       ...
                       ESYS_TR       shandle3) {
    TSS2_RC r;
    LOG_TRACE("context=%p, keyHandle=%" PRIx32 "", esysContext, keyHandle);
...
/** Asynchronous finish function for TPM2_Encapsulate
 *
 * This function returns the results of a TPM2_Encapsulate command
 * invoked via Esys_Encapsulate_Async.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[out] ciphertext The ML-KEM ciphertext (callee-allocated).
 * @param[out] secret The shared secret (callee-allocated).
