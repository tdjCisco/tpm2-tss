...
/** One-Call function for TPM2_SignSequenceStart
 *
 * This function invokes the TPM2_SignSequenceStart command in a one-call
 * variant. This means the function will block until the TPM response is
 * available. All input parameters are const. The memory for non-simple output
 * parameters is allocated by the function implementation.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  keyHandle Handle of the signing key.
 ...
 * @param[out] sequenceHandle Handle for signature sequence (callee-allocated).
...
Esys_SignSequenceStart(ESYS_CONTEXT              *esysContext,
     ...
     */
    do {
        r = Esys_SignSequenceStart_Finish(esysContext, sequenceHandle);
...
/** Asynchronous function for TPM2_SignSequenceStart
 *
 * This function invokes the TPM2_SignSequenceStart command in asynchronous variant.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  keyHandle Handle of the signing key.
 * @param[in]  shandle1 Session handle for authorization of keyHandle.
...
/** Asynchronous finish function for TPM2_SignSequenceStart
 *
 * This function returns the results of a TPM2_SignSequenceStart command
 * invoked via Esys_SignSequenceStart_Async.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[out] sequenceHandle Handle for signature sequence (callee-allocated).
...
Esys_SignSequenceStart_Finish(ESYS_CONTEXT *esysContext, ESYS_TR *sequenceHandle) {
    ...
    *sequenceHandle = esysContext->esys_handle_cnt++;
     ...
     */
    r = Tss2_Sys_SignSequenceStart_Complete(esysContext->sys, &sequenceHandleNode->rsrc.handle);
