...
Esys_Initialize(ESYS_CONTEXT     **esys_context,
    ...
    static TSS2_RC (*sym)(ESYS_CONTEXT **esys_context, TSS2_TCTI_CONTEXT *tcti,
                          TSS2_ABI_VERSION *abiVersion)
        = NULL;
    if (!sym)
...
#define MAKE_ESYS_5(fun, type1, parm1, type2, parm2, type3, parm3, type4, parm4, type5, parm5)     \
    TSS2_RC fun(ESYS_CONTEXT *ctx, type1 parm1, type2 parm2, type3 parm3, type4 parm4,             \
                type5 parm5) {                                                                     \
...
#define MAKE_ESYS_6(fun, type1, parm1, type2, parm2, type3, parm3, type4, parm4, type5, parm5,     \
                    type6, parm6)                                                                  \
    TSS2_RC fun(ESYS_CONTEXT *ctx, type1 parm1, type2 parm2, type3 parm3, type4 parm4,             \
                type5 parm5, type6 parm6) {                                                        \
        static TSS2_RC (*sym)(ESYS_CONTEXT * ctx, type1, type2, type3, type4, type5, type6)        \
            = NULL;                                                                                \
        if (!sym)                                                                                  \
            sym = dlsym(dlhandle, str(fun));                                                       \
        if (!sym) {                                                                                \
...
#define MAKE_ESYS_7(fun, type1, parm1, type2, parm2, type3, parm3, type4, parm4, type5, parm5,     \
                    type6, parm6, type7, parm7)                                                    \
    TSS2_RC fun(ESYS_CONTEXT *ctx, type1 parm1, type2 parm2, type3 parm3, type4 parm4,             \
                type5 parm5, type6 parm6, type7 parm7) {                                           \
        static TSS2_RC (*sym)(ESYS_CONTEXT * ctx, type1, type2, type3, type4, type5, type6, type7) \
            = NULL;                                                                                \
        if (!sym)                                                                                  \
            sym = dlsym(dlhandle, str(fun));                                                       \
        if (!sym) {                                                                                \
...
#define MAKE_ESYS_8(fun, type1, parm1, type2, parm2, type3, parm3, type4, parm4, type5, parm5,     \
                    type6, parm6, type7, parm7, type8, parm8)                                      \
    TSS2_RC fun(ESYS_CONTEXT *ctx, type1 parm1, type2 parm2, type3 parm3, type4 parm4,             \
...
#define MAKE_ESYS_9(fun, type1, parm1, type2, parm2, type3, parm3, type4, parm4, type5, parm5,     \
                    type6, parm6, type7, parm7, type8, parm8, type9, parm9)                        \
    TSS2_RC fun(ESYS_CONTEXT *ctx, type1 parm1, type2 parm2, type3 parm3, type4 parm4,             \
                type5 parm5, type6 parm6, type7 parm7, type8 parm8, type9 parm9) {                 \
        TSS2_RC(*sym)                                                                              \
        (ESYS_CONTEXT * ctx, type1, type2, type3, type4, type5, type6, type7, type8, type9)        \
            = NULL;                                                                                \
        if (!sym)                                                                                  \
            sym = dlsym(dlhandle, str(fun));                                                       \
        if (!sym) {                                                                                \
        ...
        return sym(ctx, parm1, parm2, parm3, parm4, parm5, parm6, parm7, parm8, parm9);            \
    }

#define MAKE_ESYS_10(fun, type1, parm1, type2, parm2, type3, parm3, type4, parm4, type5, parm5,    \
                     type6, parm6, type7, parm7, type8, parm8, type9, parm9, type10, parm10)       \
    TSS2_RC fun(ESYS_CONTEXT *ctx, type1 parm1, type2 parm2, type3 parm3, type4 parm4,             \
                type5 parm5, type6 parm6, type7 parm7, type8 parm8, type9 parm9, type10 parm10) {  \
        TSS2_RC(*sym)                                                                              \
        (ESYS_CONTEXT * ctx, type1, type2, type3, type4, type5, type6, type7, type8, type9,        \
         type10)                                                                                   \
            = NULL;                                                                                \
        ...
        return sym(ctx, parm1, parm2, parm3, parm4, parm5, parm6, parm7, parm8, parm9, parm10);    \
    }

#define MAKE_ESYS_11(fun, type1, parm1, type2, parm2, type3, parm3, type4, parm4, type5, parm5,    \
                     type6, parm6, type7, parm7, type8, parm8, type9, parm9, type10, parm10,       \
                     type11, parm11)                                                               \
    TSS2_RC fun(ESYS_CONTEXT *ctx, type1 parm1, type2 parm2, type3 parm3, type4 parm4,             \
                type5 parm5, type6 parm6, type7 parm7, type8 parm8, type9 parm9, type10 parm10,    \
...
#define MAKE_ESYS_12(fun, type1, parm1, type2, parm2, type3, parm3, type4, parm4, type5, parm5,    \
                     type6, parm6, type7, parm7, type8, parm8, type9, parm9, type10, parm10,       \
                     type11, parm11, type12, parm12)                                               \
    TSS2_RC fun(ESYS_CONTEXT *ctx, type1 parm1, type2 parm2, type3 parm3, type4 parm4,             \
                type5 parm5, type6 parm6, type7 parm7, type8 parm8, type9 parm9, type10 parm10,    \
                type11 parm11, type12 parm12) {                                                    \
        TSS2_RC(*sym)                                                                              \
...
#define MAKE_ESYS_13(fun, type1, parm1, type2, parm2, type3, parm3, type4, parm4, type5, parm5,    \
                     type6, parm6, type7, parm7, type8, parm8, type9, parm9, type10, parm10,       \
                     type11, parm11, type12, parm12, type13, parm13)                               \
    TSS2_RC fun(ESYS_CONTEXT *ctx, type1 parm1, type2 parm2, type3 parm3, type4 parm4,             \
                type5 parm5, type6 parm6, type7 parm7, type8 parm8, type9 parm9, type10 parm10,    \
                type11 parm11, type12 parm12, type13 parm13) {                                     \
        TSS2_RC(*sym)                                                                              \
...
MAKE_ESYS_1(Esys_GetTcti, TSS2_TCTI_CONTEXT **, tcti);
MAKE_ESYS_2(Esys_GetPollHandles, TSS2_TCTI_POLL_HANDLE **, handles, size_t *, count);
MAKE_ESYS_1(Esys_SetTimeout, int32_t, timeout);
MAKE_ESYS_3(Esys_TR_Serialize, ESYS_TR, object, uint8_t **, buffer, size_t *, buffer_size);
...
MAKE_ESYS_4(Esys_TR_FromTPMPublic_Async,
            ...
            ESYS_TR,
            optionalSession3);
MAKE_ESYS_1(Esys_TR_FromTPMPublic_Finish, ESYS_TR *, object);
MAKE_ESYS_5(Esys_TR_FromTPMPublic,
            ...
            ESYS_TR *,
            object);
MAKE_ESYS_1(Esys_TR_Close, ESYS_TR *, rsrc_handle);
MAKE_ESYS_2(Esys_TR_SetAuth, ESYS_TR, handle, TPM2B_AUTH const *, authValue);
MAKE_ESYS_2(Esys_TR_GetName, ESYS_TR, handle, TPM2B_NAME **, name);
MAKE_ESYS_2(Esys_TRSess_GetAttributes, ESYS_TR, session, TPMA_SESSION *, flags);
MAKE_ESYS_3(Esys_TRSess_SetAttributes, ESYS_TR, session, TPMA_SESSION, flags, TPMA_SESSION, mask);
MAKE_ESYS_2(Esys_TRSess_GetNonceTPM, ESYS_TR, session, TPM2B_NONCE **, nonceTPM);
MAKE_ESYS_2(Esys_TR_GetTpmHandle, ESYS_TR, esys_handle, TPM2_HANDLE *, tpm_handle);
MAKE_ESYS_2(Esys_TRSess_GetAuthRequired, ESYS_TR, esys_handle, TPMI_YES_NO *, auth_needed);
MAKE_ESYS_1(Esys_Startup, TPM2_SU, startupType);
MAKE_ESYS_1(Esys_Startup_Async, TPM2_SU, startupType);
...
MAKE_ESYS_4(Esys_IncrementalSelfTest_Async,
            ...
            const TPML_ALG *,
            toTest);
MAKE_ESYS_1(Esys_IncrementalSelfTest_Finish, TPML_ALG **, toDoList);
MAKE_ESYS_5(Esys_GetTestResult,
            ...
            TPM2_RC *,
            testResult);
MAKE_ESYS_3(Esys_GetTestResult_Async, ESYS_TR, shandle1, ESYS_TR, shandle2, ESYS_TR, shandle3);
MAKE_ESYS_2(Esys_GetTestResult_Finish, TPM2B_MAX_BUFFER **, outData, TPM2_RC *, testResult);
...
MAKE_ESYS_9(Esys_StartAuthSession_Async,
            ...
            TPMI_ALG_HASH,
            authHash);
MAKE_ESYS_1(Esys_StartAuthSession_Finish, ESYS_TR *, sessionHandle);
...
MAKE_ESYS_6(Esys_Load_Async,
            ...
            const TPM2B_PUBLIC *,
            inPublic);
MAKE_ESYS_1(Esys_Load_Finish, ESYS_TR *, objectHandle);
...
MAKE_ESYS_6(Esys_LoadExternal_Async,
            ...
            ESYS_TR,
            hierarchy);
MAKE_ESYS_1(Esys_LoadExternal_Finish, ESYS_TR *, objectHandle);
...
MAKE_ESYS_7(Esys_ActivateCredential_Async,
            ...
            const TPM2B_ENCRYPTED_SECRET *,
            secret);
MAKE_ESYS_1(Esys_ActivateCredential_Finish, TPM2B_DIGEST **, certInfo);
...
MAKE_ESYS_7(Esys_AC_Send_Async,
            ...
            TPM2B_MAX_BUFFER *,
            acDataIn);
MAKE_ESYS_1(Esys_AC_Send_Finish, TPMS_AC_OUTPUT **, acDataOut);
...
MAKE_ESYS_4(Esys_Unseal_Async,
            ...
            ESYS_TR,
            shandle3);
MAKE_ESYS_1(Esys_Unseal_Finish, TPM2B_SENSITIVE_DATA **, outData);
...
MAKE_ESYS_6(Esys_ObjectChangeAuth_Async,
            ...
            const TPM2B_AUTH *,
            newAuth);
MAKE_ESYS_1(Esys_ObjectChangeAuth_Finish, TPM2B_PRIVATE **, outPrivate);
...
MAKE_ESYS_9(Esys_Import_Async,
            ...
            const TPMT_SYM_DEF_OBJECT *,
            symmetricAlg);
MAKE_ESYS_1(Esys_Import_Finish, TPM2B_PRIVATE **, outPrivate);
...
MAKE_ESYS_7(Esys_RSA_Encrypt_Async,
            ...
            const TPM2B_DATA *,
            label);
MAKE_ESYS_1(Esys_RSA_Encrypt_Finish, TPM2B_PUBLIC_KEY_RSA **, outData);
...
MAKE_ESYS_7(Esys_RSA_Decrypt_Async,
            ...
            const TPM2B_DATA *,
            label);
MAKE_ESYS_1(Esys_RSA_Decrypt_Finish, TPM2B_PUBLIC_KEY_RSA **, message);
...
MAKE_ESYS_4(Esys_ECDH_KeyGen_Async,
            ...
            ESYS_TR,
            shandle3);
MAKE_ESYS_2(Esys_ECDH_KeyGen_Finish, TPM2B_ECC_POINT **, zPoint, TPM2B_ECC_POINT **, pubPoint);
...
MAKE_ESYS_5(Esys_ECDH_ZGen_Async,
            ...
            const TPM2B_ECC_POINT *,
            inPoint);
MAKE_ESYS_1(Esys_ECDH_ZGen_Finish, TPM2B_ECC_POINT **, outPoint);
...
MAKE_ESYS_4(Esys_ECC_Parameters_Async,
            ...
            TPMI_ECC_CURVE,
            curveID);
MAKE_ESYS_1(Esys_ECC_Parameters_Finish, TPMS_ALGORITHM_DETAIL_ECC **, parameters);
...
MAKE_ESYS_8(Esys_ZGen_2Phase_Async,
            ...
            UINT16,
            counter);
MAKE_ESYS_2(Esys_ZGen_2Phase_Finish, TPM2B_ECC_POINT **, outZ1, TPM2B_ECC_POINT **, outZ2);
...
MAKE_ESYS_8(Esys_EncryptDecrypt_Async,
            ...
            const TPM2B_MAX_BUFFER *,
            inData);
MAKE_ESYS_2(Esys_EncryptDecrypt_Finish, TPM2B_MAX_BUFFER **, outData, TPM2B_IV **, ivOut);
...
MAKE_ESYS_8(Esys_EncryptDecrypt2_Async,
            ...
            const TPM2B_IV *,
            ivIn);
MAKE_ESYS_2(Esys_EncryptDecrypt2_Finish, TPM2B_MAX_BUFFER **, outData, TPM2B_IV **, ivOut);
...
MAKE_ESYS_6(Esys_Hash_Async,
            ...
            ESYS_TR,
            hierarchy);
MAKE_ESYS_2(Esys_Hash_Finish, TPM2B_DIGEST **, outHash, TPMT_TK_HASHCHECK **, validation);
...
MAKE_ESYS_6(Esys_HMAC_Async,
            ...
            TPMI_ALG_HASH,
            hashAlg);
MAKE_ESYS_1(Esys_HMAC_Finish, TPM2B_DIGEST **, outHMAC);
MAKE_ESYS_6(Esys_MAC_Async,
            ...
            TPMI_ALG_MAC_SCHEME,
            inScheme);
MAKE_ESYS_1(Esys_MAC_Finish, TPM2B_DIGEST **, outMAC);
...
MAKE_ESYS_4(Esys_GetRandom_Async,
            ...
            UINT16,
            bytesRequested);
MAKE_ESYS_1(Esys_GetRandom_Finish, TPM2B_DIGEST **, randomBytes);
...
MAKE_ESYS_6(Esys_HMAC_Start_Async,
            ...
            TPMI_ALG_HASH,
            hashAlg);
MAKE_ESYS_1(Esys_HMAC_Start_Finish, ESYS_TR *, sequenceHandle);
...
MAKE_ESYS_6(Esys_MAC_Start_Async,
            ...
            TPMI_ALG_MAC_SCHEME,
            inScheme);
MAKE_ESYS_1(Esys_MAC_Start_Finish, ESYS_TR *, sequenceHandle);
...
MAKE_ESYS_5(Esys_HashSequenceStart_Async,
            ...
            TPMI_ALG_HASH,
            hashAlg);
MAKE_ESYS_1(Esys_HashSequenceStart_Finish, ESYS_TR *, sequenceHandle);
...
MAKE_ESYS_6(Esys_EventSequenceComplete_Async,
            ...
            const TPM2B_MAX_BUFFER *,
            buffer);
MAKE_ESYS_1(Esys_EventSequenceComplete_Finish, TPML_DIGEST_VALUES **, results);
...
MAKE_ESYS_7(Esys_Certify_Async,
            ...
            const TPMT_SIG_SCHEME *,
            inScheme);
MAKE_ESYS_2(Esys_Certify_Finish, TPM2B_ATTEST **, certifyInfo, TPMT_SIGNATURE **, signature);
...
MAKE_ESYS_7(Esys_Quote_Async,
            ...
            const TPML_PCR_SELECTION *,
            PCRselect);
MAKE_ESYS_2(Esys_Quote_Finish, TPM2B_ATTEST **, quoted, TPMT_SIGNATURE **, signature);
...
MAKE_ESYS_7(Esys_GetTime_Async,
            ...
            const TPMT_SIG_SCHEME *,
            inScheme);
MAKE_ESYS_2(Esys_GetTime_Finish, TPM2B_ATTEST **, timeInfo, TPMT_SIGNATURE **, signature);
...
MAKE_ESYS_4(Esys_EC_Ephemeral_Async,
            ...
            TPMI_ECC_CURVE,
            curveID);
MAKE_ESYS_2(Esys_EC_Ephemeral_Finish, TPM2B_ECC_POINT **, Q, UINT16 *, counter);
...
MAKE_ESYS_6(Esys_VerifySignature_Async,
            ...
            const TPMT_SIGNATURE *,
            signature);
MAKE_ESYS_1(Esys_VerifySignature_Finish, TPMT_TK_VERIFIED **, validation);
...
MAKE_ESYS_7(Esys_Sign_Async,
            ...
            const TPMT_TK_HASHCHECK *,
            validation);
MAKE_ESYS_1(Esys_Sign_Finish, TPMT_SIGNATURE **, signature);
...
MAKE_ESYS_5(Esys_PCR_Event_Async,
            ...
            const TPM2B_EVENT *,
            eventData);
MAKE_ESYS_1(Esys_PCR_Event_Finish, TPML_DIGEST_VALUES **, digests);
...
MAKE_ESYS_10(Esys_PolicySigned_Async,
             ...
             const TPMT_SIGNATURE *,
             auth);
MAKE_ESYS_2(Esys_PolicySigned_Finish, TPM2B_TIMEOUT **, timeout, TPMT_TK_AUTH **, policyTicket);
...
MAKE_ESYS_9(Esys_PolicySecret_Async,
            ...
            INT32,
            expiration);
MAKE_ESYS_2(Esys_PolicySecret_Finish, TPM2B_TIMEOUT **, timeout, TPMT_TK_AUTH **, policyTicket);
...
MAKE_ESYS_4(Esys_PolicyGetDigest_Async,
            ...
            ESYS_TR,
            shandle3);
MAKE_ESYS_1(Esys_PolicyGetDigest_Finish, TPM2B_DIGEST **, policyDigest);
...
MAKE_ESYS_4(Esys_FieldUpgradeData_Async,
            ...
            const TPM2B_MAX_BUFFER *,
            fuData);
MAKE_ESYS_2(Esys_FieldUpgradeData_Finish, TPMT_HA **, nextDigest, TPMT_HA **, firstDigest);
...
MAKE_ESYS_4(Esys_FirmwareRead_Async,
            ...
            UINT32,
            sequenceNumber);
MAKE_ESYS_1(Esys_FirmwareRead_Finish, TPM2B_MAX_BUFFER **, fuData);
MAKE_ESYS_2(Esys_ContextSave, ESYS_TR, saveHandle, TPMS_CONTEXT **, context);
MAKE_ESYS_1(Esys_ContextSave_Async, ESYS_TR, saveHandle);
MAKE_ESYS_1(Esys_ContextSave_Finish, TPMS_CONTEXT **, context);
MAKE_ESYS_2(Esys_ContextLoad, const TPMS_CONTEXT *, context, ESYS_TR *, loadedHandle);
MAKE_ESYS_1(Esys_ContextLoad_Async, const TPMS_CONTEXT *, context);
MAKE_ESYS_1(Esys_ContextLoad_Finish, ESYS_TR *, loadedHandle);
MAKE_ESYS_1(Esys_FlushContext, ESYS_TR, flushHandle);
MAKE_ESYS_1(Esys_FlushContext_Async, ESYS_TR, flushHandle);
...
MAKE_ESYS_6(Esys_EvictControl_Async,
            ...
            TPMI_DH_PERSISTENT,
            persistentHandle);
MAKE_ESYS_1(Esys_EvictControl_Finish, ESYS_TR *, newObjectHandle);
MAKE_ESYS_4(Esys_ReadClock,
            ...
            TPMS_TIME_INFO **,
            currentTime);
MAKE_ESYS_3(Esys_ReadClock_Async, ESYS_TR, shandle1, ESYS_TR, shandle2, ESYS_TR, shandle3);
MAKE_ESYS_1(Esys_ReadClock_Finish, TPMS_TIME_INFO **, currentTime);
...
MAKE_ESYS_6(Esys_NV_DefineSpace_Async,
            ...
            const TPM2B_NV_PUBLIC *,
            publicInfo);
MAKE_ESYS_1(Esys_NV_DefineSpace_Finish, ESYS_TR *, nvHandle);
...
MAKE_ESYS_4(Esys_NV_ReadPublic_Async,
            ...
            ESYS_TR,
            shandle3);
MAKE_ESYS_2(Esys_NV_ReadPublic_Finish, TPM2B_NV_PUBLIC **, nvPublic, TPM2B_NAME **, nvName);
...
MAKE_ESYS_7(Esys_NV_Read_Async,
            ...
            UINT16,
            offset);
MAKE_ESYS_1(Esys_NV_Read_Finish, TPM2B_MAX_NV_BUFFER **, data);
...
MAKE_ESYS_10(Esys_NV_Certify_Async,
             ...
             UINT16,
             offset);
MAKE_ESYS_2(Esys_NV_Certify_Finish, TPM2B_ATTEST **, certifyInfo, TPMT_SIGNATURE **, signature);
...
MAKE_ESYS_4(Esys_Vendor_TCG_Test_Async,
            ...
            const TPM2B_DATA *,
            inputData);
MAKE_ESYS_1(Esys_Vendor_TCG_Test_Finish, TPM2B_DATA **, outputData);
MAKE_ESYS_1(Esys_GetSysContext, TSS2_SYS_CONTEXT **, sys_context);
MAKE_ESYS_1(Esys_SetCryptoCallbacks, ESYS_CRYPTO_CALLBACKS *, callbacks);
MAKE_ESYS_3(Esys_GetCpHash, TPMI_ALG_HASH, hashAlg, uint8_t **, cpHash, size_t, *cpHash_size);
MAKE_ESYS_3(Esys_GetRpHash, TPMI_ALG_HASH, hashAlg, uint8_t **, cpHash, size_t, *cpHash_size);
...
MAKE_ESYS_8(Esys_ECC_Decrypt_Async,
            ...
            const TPMT_KDF_SCHEME *,
            inScheme);
MAKE_ESYS_1(Esys_ECC_Decrypt_Finish, TPM2B_MAX_BUFFER **, plainText);
MAKE_ESYS_6(Esys_Encapsulate,
            ESYS_TR,
            keyHandle,
            ESYS_TR,
            shandle1,
            ...
            TPM2B_SHARED_SECRET **,
            secret);
MAKE_ESYS_4(Esys_Encapsulate_Async,
            ESYS_TR,
            keyHandle,
            ESYS_TR,
            shandle1,
            ...
            ESYS_TR,
            shandle3);
MAKE_ESYS_2(Esys_Encapsulate_Finish,
            TPM2B_KEM_CIPHERTEXT **,
            ciphertext,
            TPM2B_SHARED_SECRET **,
            secret);
MAKE_ESYS_6(Esys_Decapsulate,
            ESYS_TR,
            keyHandle,
            ESYS_TR,
            shandle1,
            ...
            ESYS_TR,
            shandle3,
            const TPM2B_KEM_CIPHERTEXT *,
            ciphertext,
            TPM2B_SHARED_SECRET **,
            secret);
MAKE_ESYS_5(Esys_Decapsulate_Async,
            ESYS_TR,
            keyHandle,
            ESYS_TR,
            shandle1,
            ...
            const TPM2B_KEM_CIPHERTEXT *,
            ciphertext);
MAKE_ESYS_1(Esys_Decapsulate_Finish, TPM2B_SHARED_SECRET **, secret);
MAKE_ESYS_8(Esys_SignDigest,
            ESYS_TR,
            keyHandle,
            ESYS_TR,
            shandle1,
            ...
            TPMT_SIGNATURE **,
            signature);
MAKE_ESYS_7(Esys_SignDigest_Async,
            ESYS_TR,
            keyHandle,
            ESYS_TR,
            shandle1,
            ...
            const TPMT_TK_HASHCHECK *,
            validation);
MAKE_ESYS_1(Esys_SignDigest_Finish, TPMT_SIGNATURE **, signature);
MAKE_ESYS_7(Esys_SignSequenceStart,
            ESYS_TR,
            keyHandle,
            ESYS_TR,
            shandle1,
            ...
            ESYS_TR *,
            sequenceHandle);
MAKE_ESYS_6(Esys_SignSequenceStart_Async,
            ESYS_TR,
            keyHandle,
            ESYS_TR,
            shandle1,
            ...
            const TPM2B_SIGNATURE_CTX *,
            context);
MAKE_ESYS_1(Esys_SignSequenceStart_Finish, ESYS_TR *, sequenceHandle);
MAKE_ESYS_8(Esys_SignSequenceComplete,
            ESYS_TR,
            sequenceHandle,
            ESYS_TR,
            shandle1,
            ...
            TPMT_TK_HASHCHECK **,
            validation);
MAKE_ESYS_6(Esys_SignSequenceComplete_Async,
            ESYS_TR,
            sequenceHandle,
            ESYS_TR,
            shandle1,
            ...
            ESYS_TR,
            hierarchy);
MAKE_ESYS_2(Esys_SignSequenceComplete_Finish,
            TPMT_SIGNATURE **,
            signature,
            TPMT_TK_HASHCHECK **,
            validation);
MAKE_ESYS_8(Esys_VerifyDigestSignature,
            ESYS_TR,
            keyHandle,
            ESYS_TR,
            shandle1,
            ...
            TPMT_TK_VERIFIED **,
            validation);
MAKE_ESYS_7(Esys_VerifyDigestSignature_Async,
            ESYS_TR,
            keyHandle,
            ESYS_TR,
            shandle1,
            ...
            const TPMT_SIGNATURE *,
            signature);
MAKE_ESYS_1(Esys_VerifyDigestSignature_Finish, TPMT_TK_VERIFIED **, validation);
MAKE_ESYS_6(Esys_VerifySequenceStart,
            ESYS_TR,
            keyHandle,
            ESYS_TR,
            shandle1,
            ...
            const TPM2B_SIGNATURE_CTX *,
            context);
MAKE_ESYS_6(Esys_VerifySequenceStart_Async,
            ESYS_TR,
            keyHandle,
            ESYS_TR,
            shandle1,
            ...
            const TPM2B_SIGNATURE_CTX *,
            context);
MAKE_ESYS_0(Esys_VerifySequenceStart_Finish);
MAKE_ESYS_7(Esys_VerifySequenceComplete,
            ESYS_TR,
            sequenceHandle,
            ESYS_TR,
            keyHandle,
            ...
            TPMT_TK_VERIFIED **,
            validation);
MAKE_ESYS_6(Esys_VerifySequenceComplete_Async,
            ESYS_TR,
            sequenceHandle,
            ESYS_TR,
            keyHandle,
            ...
            const TPMT_SIGNATURE *,
            signature);
MAKE_ESYS_1(Esys_VerifySequenceComplete_Finish, TPMT_TK_VERIFIED **, validation);
